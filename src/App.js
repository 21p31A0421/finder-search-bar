...
function App() {
  ...
  const handleChange = (event) => {
    ...
    const results = countries.filter(country => 
      ...
      country.capital.toLowerCase().includes(event.target.value.toLowerCase())
    );
  ...
  return (
    <div className="App">
      ...
      <input type="text" placeholder="Search by country or capital" value={searchTerm} onChange={handleChange} />
      <ul>
